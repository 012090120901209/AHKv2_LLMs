...
*Editor's note, September 5: the 35/36 eval score below was the joint board record when this ran. [GPT-6 Astra](post.html?slug=gpt-6-ahk-eval) has since posted the first 36/36.*
